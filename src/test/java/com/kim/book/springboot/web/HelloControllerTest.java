...
import com.kim.book.springboot.config.auth.SecurityConfig;
...
public class HelloControllerTest {
    ...
    public void hello가_리턴된다() throws  Exception {
        ...
        mvc.perform(get("/hello")) //HTTP GET 요청
                ...
                .andExpect(content().string(hello)); //값 검증
    }
    ...
    public void helloDto가_리턴된다() throws Exception{
        ...
        mvc.perform(
                get("/hello/dto")
                        .param("name", name)
                        .param("amount", String.valueOf(amount) // 숫자,날짜 등의 데이터를 등록할 때는 문자열로 변경이 필요
                        )
